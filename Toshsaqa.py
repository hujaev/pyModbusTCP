...
def motor_sensor():
    ...
    #senso
        try:
            ...
            labelmotorSensor6.configure(bg='black', fg="white",text="0")
    ...
    motorSensor4 = round(pastki_sath4 -(float(motorSensor4a) / 1000), 2)
    motorSensor5 = round(pastki_sath5 -(float(motorSensor5a) / 1000), 2)
    # motorSensor6 = round(pastki_sath6 -(float(motorSensor6a) / 100), 2)
...
labelOut1Cub.grid(row=15, column=2)
